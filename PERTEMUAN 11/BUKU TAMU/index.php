...
<body>
    <div class="container" style="margin-top: 50px">
        ...
        if (isset($_POST['submit'])) {
            ...
            $input = $koneksi->query("INSERT INTO daftartamu(tanggal,nama,email,notelp,keperluan,pesan) VALUES('$tanggal','$nama','$email','$notelp','$keperluan','$pesan')") or die($koneksi->error);
            if ($input) {
        ...
        $res = $koneksi->query("SELECT * FROM daftartamu ORDER BY id DESC LIMIT 5") or die($koneksi->error);
